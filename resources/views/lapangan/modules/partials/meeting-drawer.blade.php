{{-- Drawer tambah jadwal meeting vendor — combobox booking + auto-fill --}}
...
<aside x-show="drawerOpen"
    ...
    <div class="flex-1 min-h-0 overflow-y-auto overscroll-contain p-6 pb-2">
        ...
        <form method="POST"
              action="{{ route('lapangan.vendor-meetings.store') }}"
              class="space-y-5"
              @submit="submitting = true">
            @csrf
            <input type="hidden" name="booking_id" :value="form.booking_id">

            {{-- Combobox: pilih booking --}}
            ...
            {{-- Auto-fill: ID Pesanan & Nama Klien --}}
