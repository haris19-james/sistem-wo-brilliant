<div class="bg-white border border-green-100 rounded-3xl p-5 shadow-sm hover:shadow-md transition" data-task-id="{{ $task->id }}" data-task-name="{{ $task->nama_tugas }}">
    <div class="flex items-start justify-between gap-4">
        ...
        <div class="flex flex-col items-end gap-2">
            <span data-status-badge class="inline-flex items-center px-3 py-1 rounded-full bg-green-50 text-green-700 text-xs font-semibold">Selesai</span>
            <select class="task-status-select text-sm px-2 py-1 border border-gray-200 rounded" data-task-id="{{ $task->id }}" data-prev-status="completed">
