...
class PengaturanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lapangan.modules.pengaturan.index', [
            'user' => $user,
            'activeMenu' => 'pengaturan',
            'settingsSection' => $section,
            'settingsMenuItems' => SettingsMenu::forUser($user, route('lapangan.pengaturan')),
    ...
    public function update(Request $request)
    {
        ...
        return redirect()
            ->route('lapangan.pengaturan', ['tab' => 'pengaturan_akun'])
