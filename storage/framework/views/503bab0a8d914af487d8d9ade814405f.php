...
<aside x-show="drawerOpen"
    ...
    <div class="flex-1 min-h-0 overflow-y-auto overscroll-contain p-6 pb-2">
        ...
        <form id="tugasDrawerForm"
            method="POST"
            action="<?php echo e(route('lapangan.tugas.store')); ?>"
            data-no-loading
            novalidate
            ...
            <div>
                ...
                <select name="pesanan_id" x-model="form.pesanan_id" @change="onAcaraChange()" required
                    ...
                    <?php $__currentLoopData = $acaraForDrawer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($a->id); ?>"><?php echo e($a->nama_pasangan); ?> — <?php echo e($a->nomor_pesanan); ?></option>
            ...
            <div>
                ...
                <select name="pic_id" x-model="form.pic_id" required
                    ...
                    <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?> (<?php echo e($user->role === 'lapangan' ? 'Korlap' : $user->role); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
<?php /**PATH C:\laragon\www\sistem-wo-brilliant2\resources\views/lapangan/modules/partials/tugas-drawer.blade.php ENDPATH**/ ?>