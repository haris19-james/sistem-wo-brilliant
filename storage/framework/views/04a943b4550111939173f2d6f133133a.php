...
<div id="korlapVendorRoot" class="w-full h-full overflow-hidden flex flex-col"
     data-api-vendors="<?php echo e($apiVendorsUrl); ?>"
     data-api-detail="<?php echo e($apiVendorDetailUrl); ?>"
     data-initial-vendor-id="<?php echo e($firstVendorId); ?>">
    ...
    <div class="flex flex-1 overflow-hidden gap-6 px-6 lg:px-8 pb-6">
        <div class="flex-1 flex flex-col min-w-0 bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div class="p-4 border-b border-gray-200">
                <form id="korlapVendorFilterForm" method="GET" class="flex flex-wrap gap-2">
                    <div class="flex-1 min-w-[160px] relative">
                        ...
                        <input type="search" name="search" value="<?php echo e($searchFilter); ?>" placeholder="Cari nama vendor..."
                    ...
                    <select name="kategori" class="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-green-500 focus:outline-none bg-white min-w-[140px]">
                        ...
                        <option value="<?php echo e($opt['slug']); ?>" <?php if($kategoriFilter === $opt['slug'] || $kategoriFilter === $opt['label']): echo 'selected'; endif; ?>><?php echo e($opt['label']); ?></option>
                    ...
                    <select name="monitoring_status" class="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-green-500 focus:outline-none bg-white min-w-[130px]">
                        ...
                        <option value="aktif" <?php if($monitoringFilter === 'aktif'): echo 'selected'; endif; ?>>Aktif di Acara</option>
                        <option value="tersedia" <?php if($monitoringFilter === 'tersedia'): echo 'selected'; endif; ?>>Tersedia</option>
                    </select>
            ...
            <div class="flex-1 overflow-y-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100" id="vendorList">
                        ...
                        <tr data-vendor-id="<?php echo e($v['id']); ?>"
                            class="vendor-row cursor-pointer border-l-4 transition hover:bg-green-50/40 <?php echo e($loop->first ? 'bg-green-50 border-green-500' : 'border-transparent'); ?>">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 flex-shrink-0 rounded-full overflow-hidden bg-gray-100">
                                        <img src="<?php echo e($v['image_url']); ?>" alt="" class="w-full h-full object-cover">
                                    </div>
                                    <div class="min-w-0">
                                        <p class="font-bold text-gray-900 truncate"><?php echo e($v['nama_vendor']); ?></p>
                                        <p class="text-xs text-gray-500 truncate"><?php echo e($v['lokasi'] ?? '—'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-gray-700"><?php echo e($v['kategori']); ?></td>
                            <td class="px-4 py-3 text-xs text-gray-600">
                                <div><?php echo e($v['telepon']); ?></div>
                                <div class="truncate max-w-[140px]"><?php echo e($v['email']); ?></div>
                            </td>
                            <td class="px-4 py-3">
                                <?php if($v['monitoring_status'] === 'aktif_di_acara'): ?>
                                <span class="inline-flex flex-col px-2.5 py-1 rounded-lg text-xs font-semibold text-green-600 bg-green-50 border border-green-100">
                                    Aktif di Acara
                                    <?php if($v['nomor_pesanan']): ?>
                                    <span class="text-[10px] font-medium text-green-700 mt-0.5"><?php echo e($v['nomor_pesanan']); ?></span>
                                    <?php endif; ?>
                                </span>
                                <?php else: ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                <span class="font-semibold text-gray-900"><?php echo e($v['rating']); ?></span>
                                <?php else: ?>
            ...
            <div class="px-4 py-2 border-t border-gray-100 bg-gray-50 text-xs text-gray-500 text-center">
                Menampilkan <?php echo e($vendors->count()); ?> rekanan master · Pembaruan real-time saat filter
            </div>
        </div>
...
<script src="<?php echo e(asset('js/korlap-vendor.js')); ?>?v=2" defer></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.lapangan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-wo-brilliant2\resources\views/lapangan/modules/vendor/index.blade.php ENDPATH**/ ?>