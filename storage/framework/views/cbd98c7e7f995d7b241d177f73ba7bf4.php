  ...
  <div class="bg-white rounded-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
    ...
    <div class="sticky top-0 bg-gradient-to-r from-pink-50 to-rose-50 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-gray-600 mt-1"><?php echo e($meeting->title); ?></p>
      </div>
    ...
    <form action="<?php echo e(route('lapangan.vendor-meetings.complete', $meeting)); ?>" method="POST" class="p-6 space-y-6">
      <?php echo csrf_field(); ?>
      ...
      <div class="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <div>
          ...
          <p class="text-sm font-medium text-gray-900 mt-1">
            <?php echo e($meeting->meeting_date->translatedFormat('d F Y')); ?>

            <span class="text-gray-600">@ <?php echo e($meeting->meeting_time); ?></span>
          </p>
        </div>
        <div>
          <p class="text-xs font-semibold text-gray-500 uppercase">Lokasi</p>
          <p class="text-sm font-medium text-gray-900 mt-1"><?php echo e($meeting->location); ?></p>
        </div>
      </div>
...
<?php /**PATH C:\laragon\www\sistem-wo-brilliant2\resources\views/lapangan/modules/vendor-meetings/complete_form.blade.php ENDPATH**/ ?>